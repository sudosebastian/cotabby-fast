...
enum SettingsItem: String, CaseIterable, Identifiable {
    ...
    var title: String {
        ...
        case .showMenuBarIcon: return "Show Tabfast in Menu Bar"
        ...
        case .toggleTabby: return "Toggle Tabfast"
        ...
        case .support: return "Support Tabfast"
    ...
    var summary: String {
        switch self {
        case .enableGlobally: return "Turn Tabfast on or off everywhere without quitting."
        ...
        case .resetAllSettings: return "Restore every Tabfast setting to its original default."
        ...
        case .showMenuBarIcon: return "Hide menu bar clutter while Tabfast keeps running."
        ...
        case .length: return "How many words Tabfast aims for per suggestion."
        case .name: return "What Tabfast should call you."
        ...
        case .endpointStatus: return "Whether Tabfast can reach the server and list its models."
        ...
        case .toggleTabby: return "A global hotkey that turns Tabfast on or off."
        case .disabledApps: return "Apps where Tabfast never autocompletes."
        ...
        case .checkForUpdates: return "See if a newer Tabfast is available."
        case .support: return "Tip the two students who build Tabfast."
        case .githubRepository: return "Browse the source code and issues."
        case .wiki: return "Documentation and the contributor guide."
        case .acknowledgements: return "Third-party packages Tabfast ships with."
        case .uninstall: return "Remove Tabfast and its data from this Mac."
        }
    }
